...
public class EventFunctions {
    ...
    static {
        ...
        register(CommonFunctions.UPDATE_BLOCK_PROPERTY,
                new UpdateBlockPropertyFunction.FactoryImpl<>(EventConditions::fromMap));
        ...
        register(CommonFunctions.UPDATE_INTERACTION_TICK,
                new UpdateInteractionFunction.FactoryImpl<>(EventConditions::fromMap));
        ...
        register(CommonFunctions.REMOVE_POTION_EFFECT,
                new RemovePotionEffectFunction.FactoryImpl<>(EventConditions::fromMap));
        ...
        register(CommonFunctions.REPLACE_FURNITURE,
                new ReplaceFurnitureFunction.FactoryImpl<>(EventConditions::fromMap));
        register(CommonFunctions.ROTATE_FURNITURE, new RotateFurnitureFunction.FactoryImpl<>(EventConditions::fromMap));
        register(CommonFunctions.MYTHIC_MOBS_SKILL,
                new MythicMobsSkillFunction.FactoryImpl<>(EventConditions::fromMap));
        ...
        register(CommonFunctions.IF_ELSE,
                new IfElseFunction.FactoryImpl<>(EventConditions::fromMap, EventFunctions::fromMap));
        register(CommonFunctions.ALTERNATIVES,
                new IfElseFunction.FactoryImpl<>(EventConditions::fromMap, EventFunctions::fromMap));
        register(CommonFunctions.WHEN,
                new WhenFunction.FactoryImpl<>(EventConditions::fromMap, EventFunctions::fromMap));
        register(CommonFunctions.DAMAGE_ITEM, new DamageItemFunction.FactoryImpl<>(EventConditions::fromMap));
        register(CommonFunctions.CYCLE_BLOCK_PROPERTY,
                new CycleBlockPropertyFunction.FactoryImpl<>(EventConditions::fromMap));
        ...
        register(CommonFunctions.PLAY_TOTEM_ANIMATION,
                new PlayTotemAnimationFunction.FactoryImpl<>(EventConditions::fromMap));
        ...
        register(CommonFunctions.APPLY_DATA, new ApplyDataFunction.FactoryImpl<>(EventConditions::fromMap));
        register(CommonFunctions.SET_LORE, new SetLoreFunction.FactoryImpl<>(EventConditions::fromMap));
    }
    ...
    public static Function<Context> fromMap(Map<String, Object> map) {
        String type = ResourceConfigUtils.requireNonEmptyStringOrThrow(map.get("type"),
                "warning.config.function.missing_type");
        ...
        if (eventsObj instanceof Map<?, ?> eventsSection) {
            ...
            for (Map.Entry<String, Object> eventEntry : eventsSectionMap.entrySet()) {
                try {
                    ...
                    events.put(eventTrigger,
                            ResourceConfigUtils.parseConfigAsList(eventEntry.getValue(), EventFunctions::fromMap));
                } catch (IllegalArgumentException e) {
                    throw new LocalizedResourceConfigException("warning.config.event.invalid_trigger",
                            eventEntry.getKey());
                }
            }
            ...
            for (Map<String, Object> eventSection : eventsList) {
                String on = ResourceConfigUtils.requireNonEmptyStringOrThrow(eventSection.get("on"),
                        "warning.config.event.missing_trigger");
                try {
                    ...
                    if (eventSection.containsKey("type")) {
                        ...
                        events.computeIfAbsent(eventTrigger, k -> new ArrayList<>(4))
                                .add(Objects
                                        .requireNonNull(
                                                BuiltInRegistries.EVENT_FUNCTION_FACTORY.getValue(CommonFunctions.RUN))
                                        .create(eventSection));
                    }
                } catch (IllegalArgumentException e) {
